...
// =========================================================================
// 2. CURRICULUM_LEVELS: تعريف المستويات الثلاثة (تم تصحيح المفاتيح)
// =========================================================================

const CURRICULUM_LEVELS = {
    // -----------------------------------------------------------------------------------------------------------------------------------
    // A. BUILDING: مستوى البناء (المفتاح مطابق لـ ID الطالب)
    // -----------------------------------------------------------------------------------------------------------------------------------
    BUILDING: {
        id: "BUILDING",
        name: "البناء",
    ...
    // -----------------------------------------------------------------------------------------------------------------------------------
    // B. DEVELOPMENT: مستوى التطوير (المفتاح مطابق لـ ID الطالب)
    // -----------------------------------------------------------------------------------------------------------------------------------
    DEVELOPMENT: {
        id: "DEVELOPMENT",
        name: "التطوير",
    ...
    // -----------------------------------------------------------------------------------------------------------------------------------
    // C. ADVANCED: مستوى المتقدم (المفتاح مطابق لـ ID الطالب)
    // -----------------------------------------------------------------------------------------------------------------------------------
    ADVANCED: {
        id: "ADVANCED",
        name: "المتقدم",
    ...
    // -----------------------------------------------------------------------------------------------------------------------------------
    // D. COMPLETION: مستوى الإكمال (هدف نهائي)
    // -----------------------------------------------------------------------------------------------------------------------------------
    COMPLETION: {
        id: "COMPLETION",
        name: "إكمال المنهج",
...
// =========================================================================
// 3. REVIEW_METHODOLOGY: تفاصيل مهام المراجعة (تم تصحيح المفاتيح لتتوافق مع IDs المستويات)
// =========================================================================

const REVIEW_METHODOLOGY = {
    // المفاتيح هنا (BUILDING, DEVELOPMENT, ADVANCED) يجب أن تتطابق تمامًا مع مفاتيح CURRICULUM_LEVELS
    BUILDING: [
        "الطارق", "الأعلى", "الغاشية", "الفجر (1-16)", "الفجر (17-30)", "البلد",
        "الشمس", "الليل", "الضحى والشرح", "التين", "العلق", "القدر",
        "البينة", "الزلزلة والعاديات", "القارعة والتكاثر",
        "العصر والهمزة والفيل", "قريش والماعون والكوثر",
        "الكافرون والنصر والمسد", "الإخلاص والفلق والناس",
    ],
    DEVELOPMENT: [
        "القلم (1-33)", "القلم (34-52)", "الحاقة (1-24)", "الحاقة (25-52)", "المعارج (1-28)",
        "المعارج (29-44)", "نوح (1-20)", "نوح (21-28)", "الجن (1-13)", "الجن (14-28)",
        "المزمل", "المدثر (1-31)", "المدثر (32-56)", "القيامة (1-19)", "القيامة (20-40)",
        "الإنسان (1-18)", "الإنسان (19-31)", "المرسلات (1-33)", "المرسلات (34-50)",
        "النبأ (1-20)", "النبأ (21-40)", "النازعات (1-26)", "النازعات (27-46)",
        "عبس (1-23)", "عبس (24-42)", "التكوير (1-14)", "التكوير (15-29)", "الانفطار",
        "المطففين (1-21)", "المطففين (22-36)", "الانشقاق", "البروج والطارق",
        "الأعلى والغاشية", "الفجر والبلد", "الشمس والليل والضحى والشرح",
        "التين والعلق والقدر والبينة", "الزلزلة إلى الناس",
    ],
    ADVANCED: [
        "الأحقاف (1-16)", "الأحقاف (17-35)", "محمد (1-19)", "محمد (20-38)", "الفتح (1-15)",
        "الفتح (16-29)", "الحجرات", "ق", "الذاريات", "الطور", "النجم", "القمر",
        "الرحمن", "الواقعة", "الحديد (1-18)", "الحديد (19-29)", "المجادلة (1-12)",
        "المجادلة (13-22)", "الحشر (1-12)", "الحشر (13-24)", "الممتحنة (1-7)",
        "الممتحنة (8-13)", "الصف", "الجمعة", "المنافقون", "التغابن", "الطلاق",
        "التحريم", "الملك", "القلم", "الحاقة", "المعارج", "نوح", "الجن", "المزمل",
        "المدثر", "القيامة", "الإنسان", "المرسلات", "النبأ", "النازعات",
        "عبس والتكوير", "الإنفطار والمطففين", "الإنشقاق والبروج", "الطارق إلى الفجر",
        "البلد إلى الناس",
    ],
};
...
// التصدير (Exports)
// =========================================================================
// التصدير مطلوب لتمكين ملف app.js من استخدام هذه البيانات.
export { SURAH_DETAILS, CURRICULUM_LEVELS, REVIEW_METHODOLOGY };
