...
// =========================================================================
// 2. CURRICULUM_LEVELS: تعريف المستويات الثلاثة (المرجعية الثابتة)
// =========================================================================

const CURRICULUM_LEVELS = {
    // -----------------------------------------------------------------------------------------------------------------------------------
    // A. LEVEL_BUILDING: مستوى البناء
    // -----------------------------------------------------------------------------------------------------------------------------------
    LEVEL_BUILDING: {
        id: "BUILDING",
        name: "البناء",
    ...
    // -----------------------------------------------------------------------------------------------------------------------------------
    // B. LEVEL_DEVELOPMENT: مستوى التطوير
    // -----------------------------------------------------------------------------------------------------------------------------------
    LEVEL_DEVELOPMENT: {
        id: "DEVELOPMENT",
        name: "التطوير",
    ...
    // -----------------------------------------------------------------------------------------------------------------------------------
    // C. LEVEL_ADVANCED: مستوى المتقدم
    // -----------------------------------------------------------------------------------------------------------------------------------
    LEVEL_ADVANCED: {
        id: "ADVANCED",
        name: "المتقدم",
    ...
    // -----------------------------------------------------------------------------------------------------------------------------------
    // D. LEVEL_COMPLETION: مستوى الإكمال (هدف نهائي)
    // -----------------------------------------------------------------------------------------------------------------------------------
    LEVEL_COMPLETION: {
        id: "COMPLETION",
        name: "إكمال المنهج",
...
// =========================================================================
// 3. REVIEW_METHODOLOGY: تفاصيل مهام المراجعة (حسب الأقسام المرسلة)
// =========================================================================

const REVIEW_METHODOLOGY = {
    // يجب أن تكون أسماء هذه المفاتيح مطابقة لأسماء الأقسام المذكورة في murajaa_label بالأعلى
    قسم_البناء: [
